...
module.exports = class extends Generator {
  ...
  writing() {
    ...
    this.fs.copyTpl(
      this.templatePath('_ComponentStyles.css'),
      this.destinationPath(`${this.config.get('root')}/${this.answers.moduleName}/components/${this.answers.componentName}Styles.css`),
      this.answers
    )
  }
}